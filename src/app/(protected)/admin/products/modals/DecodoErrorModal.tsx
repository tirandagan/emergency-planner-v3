...
export default function DecodoErrorModal({ isOpen, onClose, message, errors }: DecodoErrorModalProps) {
    if (!isOpen) return null;

    return (
        <div className="fixed inset-0 bg-black/90 backdrop-blur-sm flex items-center justify-center p-4 z-[100]">
            <div className="bg-[#0f1117] border border-red-900/50 rounded-xl w-full max-w-3xl shadow-2xl flex flex-col animate-in fade-in zoom-in-95 overflow-hidden max-h-[80vh]">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        {errors && errors.length > 0 && (
                            <div className="mt-4 space-y-2">
                                <div className="text-xs font-semibold text-gray-300 uppercase mb-2">
                                    Error Details:
                                </div>
                                <div className="bg-black/40 border border-red-900/30 rounded-lg p-4 max-h-96 overflow-y-auto">
