...
import { Sparkles, Package, X, ExternalLink } from 'lucide-react';

interface FetchFromAmazonModalProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm: () => void;
    detectionMethod: 'url' | 'asin';
    detectionValue: string;
}

export default function FetchFromAmazonModal({
    isOpen,
    onClose,
    onConfirm,
    detectionMethod,
    detectionValue
}: FetchFromAmazonModalProps) {
                ...
                <div className="p-6 bg-primary/10 border-b border-primary/30 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-muted-foreground text-sm">
                            Would you like to automatically fetch product details from Amazon?
                        </p>
                    </div>
                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <div className="text-xs font-semibold text-muted-foreground uppercase mb-1">
                                    {detectionMethod === 'url' ? 'Fetching via Product URL' : 'Fetching via ASIN'}
                                </div>
