...
### What NOT to Do
- ❌ Wait to see how serious it is (by then, shelves are empty)
- ❌ Continue normal social activities (spreads disease)
- ❌ Panic buy irresponsibly (causes community-wide shortages)
- ❌ Ignore early symptoms (early treatment is critical)
- ❌ Share supplies across households (cross-contamination risk)
...
- {{food_calories}} calories per person per day × {{family_size}} × 30
...
**Water:**
- {{water_supply}} gallons stored (1 gal/person/day × 30)
...
- Fever >103°F that doesn't respond to medication
